...
open class DockerApi : BaseApi() {
    ...
    fun dockerRunCommand(
        projectId: String, pipelineId: String, buildId: String,
    ...
    open fun dockerRunCustomize(
        projectId: String, pipelineId: String, buildId: String, param: DockerRunRequest
    ): DockerRunResponse? {
        return null
    }
    ...
    open fun dockerRunGetLogCustomize(
        projectId: String, pipelineId: String, buildId: String, param: DockerRunLogRequest
